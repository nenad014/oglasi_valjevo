...
<?php require 'includes/navbar.php'; ?>
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-sm-6">
				<h1 class="display-4 text-center"><?php echo strtoupper($cat); ?></h1>
				<hr>
				<?php
				$sql = "SELECT *, users.username FROM oglasi INNER JOIN users ON oglasi.user_id = users.id WHERE oglasi.category = '$cat'";
