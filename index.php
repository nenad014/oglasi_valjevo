	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-sm-6">
				...
				<?php
				$sql = "SELECT oglasi.id, oglasi.user_id, oglasi.title, oglasi.category, oglasi.price, oglasi.text, oglasi.date, users.username FROM oglasi INNER JOIN users ON oglasi.user_id = users.id ORDER BY oglasi.date DESC";
